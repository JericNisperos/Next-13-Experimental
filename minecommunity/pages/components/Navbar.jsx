      ...
      <nav className="w-full bg-gray-800 shadow">
        <div className="justify-between px-4 mx-auto lg:max-w-5 md:items-center md:flex md:px-8">
            ...
            >
              ...
              >
                <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                  ...
                  >
                    <li
                      className={`text-white font-extrabold underline-offset-0 px-3 py-2 ${
                        router.pathname === "/"
          ...
          <div alt="discord tska IP">
            <a className="text-white px-3 py-2 mx-3  hover:text-black bg-blue-300 text-xs">
            <FontAwesomeIcon icon={faDiscord} size="xs" className="text-xs" />
            </a>
                <motion.a className="text-white font-extrabold px-3 py-2 bg-blue-500  rounded-md border-solid border-2 border-blue-500 cursor-pointer" onClick={()=> {IPAddress === "PLAY.MINE-SMP.ME" ? setIPAddress("📋 Copied!") : setIPAddress("PLAY.MINE-SMP.ME")}}>
            {IPAddress}
            </motion.a>
          </div>
        </div>
