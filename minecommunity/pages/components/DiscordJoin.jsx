  ...
  return (
    <div>
      <motion.div initial={{ y: "10%" }} animate={{ y: 0 }} transition={{ duration: 0.5 }} className="  rounded-lg mx-auto p-8 grid grid-cols-1 lg:grid-cols-3 md:mx-96 mt-8 cursor-default ">
        <motion.div whileHover={{ scale: 1.5 }} initial={{ y: "10%" }} animate={{ y: 0, scale: 1.3 }} transition={{ duration: 0.5 }} className="rounded-lg flex flex-col justify-center items-center mx-4 ">
        ...
        <div className="rounded-lg col-span-2 mt-0 md:py-2">
          <h1 className="text-blue-400 text-2xl md:text-4xl font-black">Join us on Discord!</h1>
          <div className="md:h-full md:w-full md:relative rounded-md text-justify text-lg text-zinc-400 md:text-xl ">
