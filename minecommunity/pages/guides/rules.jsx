      ...
      <div className="mx-8">
        ...
        <div>
          <motion.div initial={{ opacity: 0, y: "10%" }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.4 } }}>
            <h1 className="text-2xl bg-red-400 mx-auto max-w-6xl justify-center items-center text-center uppercase text-white py-2">MineCommunity Chat and Communication Rules</h1>
          ...
          <motion.div initial={{ opacity: 0, y: "10%" }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.6 } }}>
            <ul className="list-none gap-2 text-lg items-center text-justify mx-4 mt-12 text-zinc-300">
              ...
              <li className="mt-4">
                8. <span className="font-black text-red-400">Never impersonate any staff member.</span> Imitating admins, mods and other Mine Community personnel is prohibited. Similarly, imitating broadcast, staff nicknames, etc is
        ...
        <div className="mx-auto max-w-6xl">
          <motion.div initial={{ opacity: 0, y: "10%" }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.8 } }}>
            <h1 className="text-2xl bg-red-400 justify-center items-center text-center uppercase text-white py-2 mt-24">MineCommunity Survival Series Server Rules</h1>
            <p className="text-lg justify-center items-center text-center text-white">Enlisted below are the rules applicable within the Survival Servers.</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: "10%" }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 1 } }}>
            <ul className="list-none gap-2 text-lg items-center text-justify mt-12 text-zinc-300">
              <li className="mt-4">
                1. <span className="font-black text-red-400">Be respectful.</span> This is a game. Enjoy what minecraft has to offer - have fun, and don't get frustrated when things go south. We discourage toxic behavior within our
                community.
              </li>
              <li className="mt-4">
              ...
              <li className="mt-4">
                3. <span className="font-black text-red-400">Do not steal.</span> Always ask for permission when using and taking other’s stuff. Whether it's an overpowered dead bush or a measly beacon, don't take any item that doesn’t
                belong to you without asking first. Abandoned areas and builds (including unclaimed areas) and '/trusted' players taking items without due consent are all violations of this rule.
              </li>
              <li className="mt-4">
              ...
              <li className="mt-4">
                5. <span className="font-black text-red-400">Inappropriate builds are not allowed.</span> Do not incorporate offensive images, figures, symbols, and the likes in your builds. This also includes map designs and banner
                patterns.
              </li>
              <li className="mt-4">
              ...
              <li className="mt-4">
                10. <span className="font-black text-red-400">No alts allowed.</span> No more than 1 account per player is allowed to play on the server. If multiple players are found using the same IP address, make sure that no one from
                your cluster gets ip banned. Bad apples can spoil the entire bunch - in this case your ip address.
              </li>
              <li className="mt-4">
          ...
          <div className="mx-auto max-w-6xl">
            <motion.div initial={{ opacity: 0, y: "10%" }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.8 } }}>
              <h1 className="text-2xl justify-center items-center text-center text-white py-2 mt-12 mb-24">
